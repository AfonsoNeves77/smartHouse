...
public class HouseIDVOTest {
    ...
    @Test
    public void givenSameHouseIDVO_ShouldReturnTrue() {
//        Arrange
        UUID houseIdentifier = UUID.randomUUID();
        HouseIDVO houseID = new HouseIDVO(houseIdentifier);
//        Act
...
//        Assert
     ...
     */
    @Test
    public void givenNullHouseIDVO_ShouldReturnFalse() {
//        Arrange
        UUID houseIdentifier = UUID.randomUUID();
        HouseIDVO houseID = new HouseIDVO(houseIdentifier);
//        Act
...
//        Assert
    ...
    @Test
    public void givenTwoHouseIDVOWithSameIdentifier_ShouldReturnTrue() {
//        Arrange
        UUID houseIdentifier = UUID.randomUUID();
        HouseIDVO houseID = new HouseIDVO(houseIdentifier);
...
//        Assert
    ...
    @Test
    public void givenTwoHouseIDVOWithDifferentIdentifier_ShouldReturnFalse() {
//        Arrange
...
//        Assert
    ...
    @Test
    public void givenHouseIDVOAndDifferentObject_ShouldReturnFalse() {
//        Arrange
        UUID houseIdentifier = UUID.randomUUID();
        HouseIDVO houseID = new HouseIDVO(houseIdentifier);
...
//        Assert
    ...
    @Test
    public void hashCodeShouldReturnCorrectHashCode() {
//        Arrange
        UUID houseIdentifier = UUID.randomUUID();
        HouseIDVO houseID = new HouseIDVO(houseIdentifier);
...
//        Assert
    ...
    @Test
    public void givenTwoHouseIDVOWithSameIdentifier_ShouldReturnSameHashCode() {
//        Arrange
        UUID houseIdentifier = UUID.randomUUID();
...
//        Assert
    ...
    @Test
    public void givenTwoHouseIDVOWithDifferentIdentifier_ShouldReturnDifferentHashCode() {
//        Arrange
        UUID houseIdentifierOne = UUID.randomUUID();
        UUID houseIdentifierTwo = UUID.randomUUID();
        HouseIDVO houseIDOne = new HouseIDVO(houseIdentifierOne);
