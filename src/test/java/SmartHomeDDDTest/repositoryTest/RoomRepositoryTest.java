...
public class RoomRepositoryTest {
     ...
     */
    @Test
    public void whenRoomIsNull_thenRoomNotSaved() {
        //Arrange
     ...
     */
    @Test
    public void whenRoomIDIsNull_thenRoomNotSaved() {
        //Arrange
        RoomRepository roomRepository = new RoomRepository();
     ...
     */
    @Test
    public void whenRoomIsValid_thenRoomIsSaved() {
        //Arrange
        RoomRepository roomRepository = new RoomRepository();
        Room room = mock(Room.class);
     ...
     */
    @Test
    public void whenRoomIsSaved_thenIsFoundByRoomId() {
        //Arrange
        RoomRepository roomRepository = new RoomRepository();
        Room room = mock(Room.class);
        RoomIDVO roomID = mock(RoomIDVO.class);
        ...
        Room result = roomRepository.findById(roomID);
     ...
     */
    @Test
    public void whenRoomsAreSaved_thenFoundInFindAll() {
        //Arrange
        RoomRepository roomRepository = new RoomRepository();
     ...
     */
    @Test
    public void whenRoomIsNotSaved_thenNotFoundWithFindAll() {
        //Arrange
        RoomRepository roomRepository = new RoomRepository();
        Room room1 = mock(Room.class);
        Room room2 = mock(Room.class);
     ...
     */
    @Test
    public void whenRoomIsNotPresent_thenNotFoundById() {
        //Arrange
        RoomRepository roomRepository = new RoomRepository();
        Room room1 = mock(Room.class);
        Room room2 = mock(Room.class);
        ...
        //Act
        Room result = roomRepository.findById(room3ID);
     ...
     */
    @Test
    public void whenHouseIDIsNotPresent_thenReturnEmptyList() {
        //Arrange
        RoomRepository roomRepository = new RoomRepository();
        Room room1 = mock(Room.class);
        Room room2 = mock(Room.class);
        ...
        //Act
        int result = roomRepository.findByHouseID(houseID).size();
     ...
     */
    @Test
    public void whenHouseIDIsPresent_thenReturnListOfRoomsInHouse() {
        //Arrange
        RoomRepository roomRepository = new RoomRepository();
        HouseIDVO houseID = mock(HouseIDVO.class);
        Room room1 = mock(Room.class);
        ...
        //Act
        List<Room> listOfRoomsInAHouse = roomRepository.findByHouseID(houseID);
