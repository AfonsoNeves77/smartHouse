...
class SensorFactoryTest {
    ...
    */
    ...
    void createSensor_WhenNullSensorNameVO_shouldReturnNull(){
        //Arrange
        SensorNameVO expectedName = null;
        ...
        //Act
        Sensor sensor = sensorFactory.createSensor(expectedName,expectedDeviceID,expectedSensorTypeID);
    ...
    void createSensor_WhenNullDeviceIDVO_shouldReturnNull(){
        ...
        DeviceIDVO expectedDeviceID =  null;
        SensorTypeIDVO expectedSensorTypeID = mock(SensorTypeIDVO.class);
        SensorFactory sensorFactory = new SensorFactory("sensor.properties");
    ...
    void createSensor_WhenNullSensorTypeIDVO_shouldReturnNull(){
        ...
        SensorNameVO expectedName = mock(SensorNameVO.class);
        DeviceIDVO expectedDeviceID = mock(DeviceIDVO.class);
        SensorTypeIDVO expectedSensorTypeID = null;
        SensorFactory sensorFactory = new SensorFactory("sensor.properties");
    ...
    void createTemperatureSensor_WhenValidVOs_shouldReturnCorrectSensor(){
        ...
        //Act
        TemperatureSensor temperatureSensor = (TemperatureSensor) sensorFactory.createSensor(expectedName, expectedDeviceID, expectedSensorTypeID);
    ...
    void createHumiditySensor_WhenValidVOs_shouldReturnCorrectSensor(){
        ...
        //Act
        HumiditySensor humiditySensor = (HumiditySensor) sensorFactory.createSensor(expectedName, expectedDeviceID, expectedSensorTypeID);
    ...
    void createPositionSensor_WhenValidVOs_shouldReturnCorrectSensor(){
        ...
        //Act
        PositionSensor positionSensor = (PositionSensor) sensorFactory.createSensor(expectedName, expectedDeviceID, expectedSensorTypeID);
    ...
    void createWindSensor_WhenValidVOs_shouldReturnCorrectSensor(){
        ...
        //Act
        WindSensor windSensor = (WindSensor) sensorFactory.createSensor(expectedName, expectedDeviceID, expectedSensorTypeID);
    ...
    void createDewPointSensor_WhenValidVOs_shouldReturnCorrectSensor(){
        ...
        //Act
        DewPointSensor dewPointSensor = (DewPointSensor) sensorFactory.createSensor(expectedName, expectedDeviceID, expectedSensorTypeID);
    ...
    void createSunsetSensor_WhenValidVOs_shouldReturnCorrectSensor(){
        ...
        //Act
        SunsetSensor sunsetSensor = (SunsetSensor) sensorFactory.createSensor(expectedName, expectedDeviceID, expectedSensorTypeID);
    ...
    void createSunriseSensor_WhenValidVOs_shouldReturnCorrectSensor(){
        ...
        //Act
        SunriseSensor sunriseSensor = (SunriseSensor) sensorFactory.createSensor(expectedName, expectedDeviceID, expectedSensorTypeID);
    ...
    void createAveragePowerConsumptionSensor_WhenValidVOs_shouldReturnCorrectSensor(){
        ...
        //Act
        AveragePowerConsumptionSensor averagePowerConsumptionSensor = (AveragePowerConsumptionSensor) sensorFactory.createSensor(expectedName, expectedDeviceID, expectedSensorTypeID);
    ...
    void createPowerConsumptionSensor_WhenValidVOs_shouldReturnCorrectSensor(){
        ...
        //Act
        PowerConsumptionSensor powerConsumptionSensor = (PowerConsumptionSensor) sensorFactory.createSensor(expectedName, expectedDeviceID, expectedSensorTypeID);
    ...
    void createSwitchSensor_WhenValidVOs_shouldReturnCorrectSensor(){
        ...
        //Act
        SwitchSensor switchSensor = (SwitchSensor) sensorFactory.createSensor(expectedName, expectedDeviceID, expectedSensorTypeID);
    ...
    void createSolarIrradianceSensor_WhenValidVOs_shouldReturnCorrectSensor(){
        ...
        //Act
        SolarIrradianceSensor irradianceSensor = (SolarIrradianceSensor) sensorFactory.createSensor(expectedName, expectedDeviceID, expectedSensorTypeID);
