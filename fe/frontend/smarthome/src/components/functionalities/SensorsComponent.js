...
const SensorsComponent = ({ deviceID, sensors, onAddSensor }) => {
    ...
    useEffect(() => {
        const fetchLogs = async () => {
            try {
                const response = await fetch('/api/smarthome/logs?deviceId=${deviceID}');
                if (!response.ok) {
    ...
    useEffect(() => {
        const fetchSensorTypes = async () => {
            try {
                const response = await fetch('/api/smarthome/sensortypes');
                if (!response.ok) {
    ...
    useEffect(() => {
        const fetchDeviceStatus = async () => {
            try {
                const response = await fetch('/api/smarthome/devices/${deviceID}');
                if (!response.ok) {
